 ...
 * 网店配置模板
 *
 * 版本 $Id: config.sample.php 85709 2016-07-19 06:15:29Z yuancheng $
 * 配置参数讨论专贴 http://www.shopex.cn/bbs/thread-61957-1-1.html
 */

#ini_set('display_errors', 1); //开启网店错误提示
...
define('SECACHE_SIZE','128M'); #缓存大小,最大不能超过1G
